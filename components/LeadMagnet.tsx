...
const LeadMagnet: React.FC = () => {
  ...
  return (
    <section id="recursos" className="py-16 sm:py-20 md:py-32 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-gradient-to-br from-cyan-900/30 to-red-800/20 rounded-full blur-3xl -z-10"></div>
